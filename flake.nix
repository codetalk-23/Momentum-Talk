{
  description = "Momentum - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          Momentum = pkgs.rustPlatform.buildRustPackage {
            pname = "Momentum";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/cjpais/Momentum";
              license = lib.licenses.mit;
              mainProgram = "Momentum";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.Momentum;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.Momentum.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.Momentum;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.Momentum.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.Momentum;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Momentum development environment"
              bun install
