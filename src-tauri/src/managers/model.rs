    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/ggml-small.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/whisper-medium-q4_1.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/ggml-large-v3-turbo.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/ggml-large-v3-q5_0.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/breeze-asr-q5_k.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/parakeet-v2-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/parakeet-v3-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/moonshine-base.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://blob.Momentum.computer/moonshine-tiny-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://blob.Momentum.computer/moonshine-small-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://blob.Momentum.computer/moonshine-medium-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/sense-voice-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/giga-am-v3-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/canary-180m-flash.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/canary-1b-v2.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://blob.Momentum.computer/cohere-int8.tar.gz".to_string()),
                sha256: Some(
