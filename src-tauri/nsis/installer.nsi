; Custom NSIS template for Momentum Talk with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Momentum Talk for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Momentum Talk releases. Require Data/
  ...
  ${AndIf} ${FileExists} "$INSTDIR\portable"
    ...
    FileRead $1 $2
    FileClose $1
    ${If} $2 == "Momentum Talk Portable Mode"
      StrCpy $PortableMode 1
    ${OrIf} $2 == ""
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Momentum Talk Portable Mode"
    FileClose $0
