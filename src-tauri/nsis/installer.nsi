; Custom NSIS template for Momentum with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Momentum for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Momentum releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Momentum Portable Mode"
    FileClose $0
