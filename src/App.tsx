...
function App() {
  ...
  // The technical error detail is logged to Momentum.log on the Rust side
    ...
    >
      <Toaster
        ...
        toastOptions={{
          ...
          classNames: {
            toast:
              "bg-background border border-border-color rounded-lg px-4 py-3 flex items-center gap-3 text-sm",
            title: "font-medium",
