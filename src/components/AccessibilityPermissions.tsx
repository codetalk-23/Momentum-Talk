...
const AccessibilityPermissions: React.FC = () => {
  ...
  const buttonConfig: Record<PermissionState, ButtonConfig | null> = {
    request: {
      ...
      className:
        "px-2 py-1 text-sm font-semibold bg-background-secondary border  border-border-color hover:bg-accent/10 rounded cursor-pointer hover:border-accent",
    },
    verify: {
      text: t("accessibility.openSettings"),
      className:
  ...
  return (
    <div className="p-4 w-full rounded-lg border border-border-color">
